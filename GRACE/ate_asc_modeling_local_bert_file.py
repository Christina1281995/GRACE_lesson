...
class PreTrainedBertModel(nn.Module):
    ...
    def from_pretrained(cls, pretrained_model_name, state_dict=None, cache_dir=None, *inputs, **kwargs):
        ...
        if resolved_archive_file == archive_file:
            ...
            #christina: changed logger to print
        ...
        if os.path.isdir(resolved_archive_file):
            ...
            #christina changed to check if file exists for notebook an
            if os.path.isfile('bert-base-uncased/bert-base-uncased.tar.gz'):
            ...
            elif os.path.isfile('../sentiment-analysis/GRACE/bert-base-uncased/bert-base-uncased.tar.gz'):
            #christina: changed the source fo the archive file to the repo location of the downloaded bert-base-uncased tar.gz file
            #with tarfile.open(resolved_archive_file, 'r:gz') as archive:
                with tarfile.open('../sentiment-analysis/GRACE/bert-base-uncased/bert-base-uncased.tar.gz', 'r:gz') as archive:
                    archive.extractall(tempdir)
                serialization_dir = tempdir
